...
| evolve | 2, 9 | none |
| grid-viewer | 5 | none |
| frame-consistency | 7 | none |
| splat-viewer | 8 | scene.splat, a synthetic still life generated by `scripts/build-splat-viewer-data.py` (CC-BY-4.0) |
| translation-sketchpad | 10 | none |
| sensor-mapper | 12 | none |
